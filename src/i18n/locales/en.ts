...
const en: UiMessagesContent = {
    ...
    emails: {
      confirm: {
        ...
        paragraphs: [
          'Please confirm your email address so we can activate your request.',
        ],
        paragraph: 'Please confirm your email address so we can activate your request.',
        cta: 'Confirm email',
        note: 'If you did not submit this request, you can ignore this email.',
        footer: 'If you did not submit this request, you can ignore this email.',
      },
      confirmedStatus: {
        subject: 'telc - Request activated',
        title: 'Your request is active',
        paragraphs: [
          'Your email address has been confirmed.',
          'We are now checking for your certificate automatically in the background.',
        ],
        paragraph: 'Your email address has been confirmed. We are now checking for your certificate automatically in the background.',
        cta: 'Open status',
        note: 'As soon as a result is available, you will receive another email.',
        footer: 'As soon as a result is available, you will receive another email.',
        support: {
          label: 'Support the project',
          message: 'If the service helps you, you can support the project with a coffee.',
          button: 'Buy me a coffee',
        },
      },
      certificateFound: {
        subject: 'telc - Certificate found',
        title: 'Your certificate has been found',
        paragraphs: [
          'A result is now available for your request.',
          'Open the status page to access the certificate link.',
        ],
        paragraph: 'A result is now available for your request. Open the status page to access the certificate link.',
        cta: 'Open status',
        note: 'The status page contains the direct link to the certificate.',
        footer: 'The status page contains the direct link to the certificate.',
        support: {
          label: 'Support the project',
          message: 'If the service helped you, you can support the project with a coffee.',
          button: 'Buy me a coffee',
        },
      },
    },
