...
const ru: UiMessagesContent = {
    ...
    index: {
      ...
      introParagraph:
        'Сервис автоматически ищет ваш сертификат telc: проверяет возможные даты в течение 35 дней и сразу уведомляет, когда сертификат найден.',
    ...
    emails: {
      ...
      confirmedStatus: {
        ...
        paragraph: 'Ваша заявка активирована. Поиск сертификата выполняется каждые 4 часа.',
